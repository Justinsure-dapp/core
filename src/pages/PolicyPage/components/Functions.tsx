    ...
    if n == 1
      ...
      <div className="flex flex-col basis-1/2">
        ...
        <p className="mt-2 text-front/60">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minus
          doloribus distinctio voluptate, recusandae voluptatem nostrum in nulla
          dolorum officia perspiciatis? Lorem ipsum dolor, sit amet consectetur
          adipisicing elit. Minima qui quidem corrupti dolores doloremque ex
          molestiae officia impedit, quasi rerum aperiam consectetur culpa
          repellendus a, quod, aspernatur sapiente molestias! Natus!
        </p>
        <div className="flex flex-col border border-front/40 p-4 hover:bg-foreground/30 duration-300 text-primary rounded-xl w-max mt-4">
          <pre className="text-xs font-mono">
            {`def bubble_sort(arr):
