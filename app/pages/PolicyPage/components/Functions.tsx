  ...
  return (
    <div className="flex flex-col py-6 gap-y-8">
      <div className="flex flex-col basis-1/2">
        ...
        <p className="mt-1 text-mute text-sm">{policy.premiumFuncDescription}</p>
        <div className="flex flex-col border border-border p-2  duration-300 text-secondary rounded-md w-max mt-4">
      ...
      <div className="flex flex-col basis-1/2">
        ...
        <p className="mt-1 text-sm text-mute">{policy.claimFuncDescription}</p>
        <div className="flex flex-col border border-border p-2 duration-300 text-secondary rounded-md w-max mt-4">
