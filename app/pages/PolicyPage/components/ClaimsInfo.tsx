...
export default function ClaimInfo({ policy }: { policy: Policy }) {
  ...
  return (
    <div>
      <div className="mt-4 flex mobile:flex-col w-full gap-x-4 gap-y-7 text-front/60 mobile:gap-x-4">
        <div className="flex w-1/3 mobile:w-full flex-col gap-y-2 text-sm">
        ...
        <div className="flex w-2/3 mobile:w-full gap-x-4">
          <div className="flex w-1/2 flex-col justify-center rounded-md border border-border bg-background px-3 duration-200 p-2 ease-in-out mobile:w-full">
            {" "}
