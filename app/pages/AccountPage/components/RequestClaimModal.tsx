    ...
    <div className="bg-background py-6 px-8 max-h-[50vh] overflow-y-scroll scrollbar-primary rounded-lg border border-primary/60 w-[40vw] flex flex-col gap-y-3">
      ...
      <div className="self-center flex flex-col mt-4 w-full gap-y-3">
        ...
        <div className="flex justify-around">
          <button
            className="border-2 py-1 px-4 rounded-lg border-red-700/80 hover:bg-red-700/80 duration-300 ease-in"
            onClick={() => modal.hide()}
          >
            Cancel
          </button>
          <button className="border-2 py-1 px-5 rounded-lg border-primary/80 hover:bg-primary/80 duration-300 ease-in hover:text-back">
            Yes
          </button>
        </div>
      </div>
