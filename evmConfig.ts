...
const surityInterface = {
  address: "0x235b0a239429c26546854d4f80f24dbe27b0ddac" as const,
  abi: [
    {
...
const surecoin = {
  address: "0xf43121220967c28686fd19fe79C7b0a0AC6657b4" as const,
  abi: [
...
const vault = {
  address: "0x7a361A44899607381bd48069053a8f938aB3CA8C" as const,
  abi: [
    { inputs: [], stateMutability: "nonpayable", type: "constructor" },
    {
      anonymous: false,
...
const usdj = {
  address: "0x2e4140d06a0b228e9dc43f8ee34a364ddcd9995e" as const,
  abi: [
    { inputs: [], stateMutability: "nonpayable", type: "constructor" },
    {
      inputs: [
